...
int main(int argc, const char * argv[])
{
    ...
    GLSphere* sphere = new GLSphere(-25.0, 0.0, 0.0, 5.0, 500, 500);
	GLSphereBlue* sphereblue = new GLSphereBlue(-10.0, 0.0, 0.0, 5.0, 500, 500);
	GLSphereGreen* spheregreen = new GLSphereGreen(5.0, 0.0, 0.0, 5.0, 500, 500);
	GLSphereSmooth* spheresmooth = new GLSphereSmooth(20.0, 0.0, 0.0, 5.0, 500, 500);
