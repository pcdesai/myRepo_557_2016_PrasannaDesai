...
*/
void GLSphereSmooth::setModelMatrix(glm::mat4& modelmatrix)
{
...
*/
void GLSphereSmooth::enableNormalVectorRenderer(bool value)
{
...
*/
void GLSphereSmooth::initVBO(void)
{
...
*/
void GLSphereSmooth::initVBONormals(void)
{
...
void GLSphereSmooth::initShader(void)
{
	...
	_light_source0._cone_angle = 32.0;
	_light_source0._cone_direction = glm::vec3(0, 0, -1);
	...
	glUniform1f(_light_source0._cone_directionIdx, _light_source0._cone_direction[0]);
...
*/
void GLSphereSmooth::initShaderNormal(void)
{
...
void GLSphereSmooth::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
